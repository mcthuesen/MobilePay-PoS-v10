...
payment. This is achieved using an *idempotency key*, which is a unique id generated by the client that must
be included as part of the initiate payment request, to identify retried requests. 
