...
| `Restrictions` | Json object with optional restrictions parameters. See [Payment Restrictions](input_formats#payment_restrictions) | A way to define restrictions on how a payment can be completed |
